...
@Composable
fun TrashRemoveScreen(navController: NavController, trashRemoveViewModel: TrashRemoveViewModel = viewModel()) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        Text("Number ${trashRemoveViewModel.number.value}")
        Button(
            onClick = {
                trashRemoveViewModel.updateNumber()
            },
            modifier = Modifier.padding(top = 16.dp)
        ) {
            Text("Increase")
